...
# JSON serialization with a fast Oj generator
gem "blueprinter"
gem "oj"
...
# Google sign-in via OmniAuth (CSRF protection enforces POST on the request phase)
gem "omniauth"
...
group :development, :test do
  ...
  # RuboCop with Omakase Ruby styling plus RSpec/Performance extensions
