...
Devise.setup do |config|
  ...
  #
  # API-only: never treat a request as navigational, so Devise returns JSON
  # (e.g. 401) instead of HTML redirects.
  ...
  # Reject passwords found in the Have I Been Pwned breach corpus. Enforced once
  # the User model adds the :pwned_password module (has_pwned_password) in Phase 1.
